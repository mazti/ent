...
func (m *CardMutation) AddedEdges() []string {
	...
	if m.owner != nil {
		edges = append(edges, cardOwner)
	}
	if m.spec != nil {
		edges = append(edges, cardSpec)
	}
	return edges
}
...
func (m *FileMutation) AddedEdges() []string {
	edges := make([]string, 0, 2)
	if m.owner != nil {
		edges = append(edges, fileOwner)
	}
	if m._type != nil {
		edges = append(edges, fileType)
	}
	return edges
}
...
func (m *FileTypeMutation) AddedEdges() []string {
	...
	if m.files != nil {
		edges = append(edges, filetypeFiles)
	}
	return edges
}
...
func (m *GroupMutation) AddedEdges() []string {
	...
	if m.files != nil {
		edges = append(edges, groupFiles)
	}
	if m.blocked != nil {
		edges = append(edges, groupBlocked)
	}
	if m.users != nil {
		edges = append(edges, groupUsers)
	}
	if m.info != nil {
		edges = append(edges, groupInfo)
	}
	return edges
}
...
// GroupInfo edge names.
const (
	groupinfoGroups = "groups"
)
...
func (m *GroupInfoMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.groups != nil {
		edges = append(edges, groupinfoGroups)
	}
	return edges
}
...
func (m *NodeMutation) AddedEdges() []string {
	edges := make([]string, 0, 2)
	if m.prev != nil {
		edges = append(edges, nodePrev)
	}
	if m.next != nil {
		edges = append(edges, nodeNext)
	}
	return edges
}
...
func (m *PetMutation) AddedEdges() []string {
	edges := make([]string, 0, 2)
	if m.team != nil {
		edges = append(edges, petTeam)
	}
	if m.owner != nil {
		edges = append(edges, petOwner)
	}
	return edges
}
...
func (m *UserMutation) AddedEdges() []string {
	...
	if m.card != nil {
		edges = append(edges, userCard)
	}
	if m.pets != nil {
		edges = append(edges, userPets)
	}
	if m.files != nil {
		edges = append(edges, userFiles)
	}
	if m.groups != nil {
		edges = append(edges, userGroups)
	}
	if m.friends != nil {
		edges = append(edges, userFriends)
	}
	if m.followers != nil {
		edges = append(edges, userFollowers)
	}
	if m.following != nil {
		edges = append(edges, userFollowing)
	}
	if m.team != nil {
		edges = append(edges, userTeam)
	}
	if m.spouse != nil {
		edges = append(edges, userSpouse)
	}
	if m.children != nil {
		edges = append(edges, userChildren)
	}
	if m.parent != nil {
		edges = append(edges, userParent)
	}
	return edges
}
