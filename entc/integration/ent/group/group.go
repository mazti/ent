...
const (
	...
	// EdgeBlocked holds the string denoting the edge name in the schema.
	EdgeBlocked = "blocked"

	// EdgeUsers holds the string denoting the edge name in the schema.
	EdgeUsers = "users"

	// EdgeInfo holds the string denoting the edge name in the schema.
	EdgeInfo = "info"
