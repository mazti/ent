...
// WithHooks appends hooks to the given client.
func (c *CardClient) WithHooks(hooks ...ent.Hook) {
...
// WithHooks appends hooks to the given client.
func (c *CommentClient) WithHooks(hooks ...ent.Hook) {
	c.hooks = append(c.hooks, hooks...)
}
...
// WithHooks appends hooks to the given client.
func (c *FieldTypeClient) WithHooks(hooks ...ent.Hook) {
	c.hooks = append(c.hooks, hooks...)
}
...
// WithHooks appends hooks to the given client.
func (c *FileClient) WithHooks(hooks ...ent.Hook) {
	c.hooks = append(c.hooks, hooks...)
}
...
// WithHooks appends hooks to the given client.
func (c *FileTypeClient) WithHooks(hooks ...ent.Hook) {
	c.hooks = append(c.hooks, hooks...)
}
...
// WithHooks appends hooks to the given client.
func (c *GroupClient) WithHooks(hooks ...ent.Hook) {
	c.hooks = append(c.hooks, hooks...)
}
...
// WithHooks appends hooks to the given client.
func (c *GroupInfoClient) WithHooks(hooks ...ent.Hook) {
	c.hooks = append(c.hooks, hooks...)
}
...
// WithHooks appends hooks to the given client.
func (c *ItemClient) WithHooks(hooks ...ent.Hook) {
	c.hooks = append(c.hooks, hooks...)
}
...
// WithHooks appends hooks to the given client.
func (c *NodeClient) WithHooks(hooks ...ent.Hook) {
	c.hooks = append(c.hooks, hooks...)
}
...
// WithHooks appends hooks to the given client.
func (c *PetClient) WithHooks(hooks ...ent.Hook) {
	c.hooks = append(c.hooks, hooks...)
}
...
// WithHooks appends hooks to the given client.
func (c *SpecClient) WithHooks(hooks ...ent.Hook) {
	c.hooks = append(c.hooks, hooks...)
}
...
// WithHooks appends hooks to the given client.
func (c *UserClient) WithHooks(hooks ...ent.Hook) {
	c.hooks = append(c.hooks, hooks...)
}
